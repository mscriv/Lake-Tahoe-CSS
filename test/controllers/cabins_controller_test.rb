...
class CabinsControllerTest < ActionController::TestCase
  ...
  test "should create cabin" do
    assert_difference('Cabin.count') do
      post :create, cabin: { bathrooms: @cabin.bathrooms, bedrooms: @cabin.bedrooms, overview: @cabin.overview, price: @cabin.price, sleeps: @cabin.sleeps, type: @cabin.type }
    end
  ...
  test "should update cabin" do
    patch :update, id: @cabin, cabin: { bathrooms: @cabin.bathrooms, bedrooms: @cabin.bedrooms, overview: @cabin.overview, price: @cabin.price, sleeps: @cabin.sleeps, type: @cabin.type }
    assert_redirected_to cabin_path(assigns(:cabin))
  end
